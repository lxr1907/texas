...
function drawLoginArea() {
    ...
    texasContext.fillText("PASSWORD", screenWidth * 0.4 - 140, screenHeight * 0.41);
    drawLoginButtons();
}
// 大厅，选房间界面
...
function drawLobbyButtons() {
    if (!LobbyButtonsDrawed) {
        ...
        var bheight = screenHeight * 0.07;
        drawControllButton(screenWidth * 0.4, screenHeight * 0.4, bwidth, bheight, "Junior Room", "enterRoom", 0);
        drawControllButton(screenWidth * 0.4, screenHeight * 0.5, bwidth, bheight, "Intermediate Room", "enterRoom", 1);
        drawControllButton(screenWidth * 0.4, screenHeight * 0.6, bwidth, bheight, "Senior Room", "enterRoom", 2);
    }
}
// 房间控制
function drawRoomButtons() {
    ...
    var bheight = screenHeight * 0.07;
    drawControllButton(screenWidth * 0.03, screenHeight * 0.02, bwidth, bheight, "Exit Room", "exitRoom", 0);
}
// 绘制一个控制按钮
