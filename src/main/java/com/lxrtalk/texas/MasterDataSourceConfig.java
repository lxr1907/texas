...
@Configuration
@MapperScan(basePackages = "com.lxrtalk.texas.dao", sqlSessionFactoryRef = "masterSqlSessionFactory")
public class MasterDataSourceConfig {
	// 精确到 master 目录，以便跟其他数据源隔离
	static final String MAPPER_LOCATION = "classpath:mapper/*.xml";
	static final String TYPE_ALIAS_PACKAGE = "com.lxrtalk.texas.entity";
